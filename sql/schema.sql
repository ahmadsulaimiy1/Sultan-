...
-- Coursework layer (LMS Phase 1): assignments a teacher sets and a
-- student submits/gets graded on. Deliberately separate from
...
CREATE TABLE IF NOT EXISTS assignment_submissions (
  ...
  status             TEXT NOT NULL DEFAULT 'not_submitted', -- not_submitted | submitted | late | graded
  score              NUMERIC(5,2),
