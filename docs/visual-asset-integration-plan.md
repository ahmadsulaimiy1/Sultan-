...
|---|---|---|---|---|
| 1 | `campus-gate.jpg` (was `61a7ff70…`) | Front gate and boundary wall, the retired `.ng` domain signage, daylight, no people | Facilities page — new "Campus in Pictures" gallery, lead image | Clean, well-composed exterior shot; a real gate photo does more for "is this a real place" credibility than any amount of copy. No identifiable individuals — no consent question. |
