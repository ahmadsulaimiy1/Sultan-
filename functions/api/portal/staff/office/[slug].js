...
// mapping get an honest empty queue, not an invented one.
...
export async function onRequestGet({ request, env, params }) {
  ...
  try {
    const officeRes = await sql`
      SELECT o.id, o.name, o.office_type, o.layer, o.slug, o.description, o.parent_office_id,
             p.name AS parent_office_name
      FROM offices o
    ...
    const [appointmentsRes, staffCountRes, meetingsRes, documentsRes] = await Promise.all([
      sql`
