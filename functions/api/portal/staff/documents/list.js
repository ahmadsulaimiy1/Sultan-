// Institutional Writing & Document Intelligence Centre — list. Mirrors
// messages/list.js's exact shape: every office this staff member
// currently holds, plus the correspondence rows scoped to it (or to a
// single office via ?officeId=).
