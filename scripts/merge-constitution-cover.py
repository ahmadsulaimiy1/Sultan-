...
FULL = os.path.join(EXPORTS, "SHRS-Governance-Charter-Flagship-Edition.pdf")
NOHEADER = os.path.join(EXPORTS, ".SHRS-Governance-Charter-Flagship-Edition.noheader.pdf")
