...
rosterRow('Mrs. Mariam Tope Anofi-AbdulKareem', 'Head Teacher, Basic School — and Registrar, Royal College', 'BSc Microbiology · BEd · PGDE · NCE').forEach(p => B.push(p));
