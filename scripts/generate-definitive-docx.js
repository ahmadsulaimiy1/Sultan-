...
B.push(caption('Zakaria Olanrewaju Anofi — Founder & Head of Schools/Administrator. BSc Oxford Brookes · MSc Heriot-Watt · Fellow, ACCA UK · Fellow, ICAN.'));
...
B.push(quoteBox('Together, let us embark on a journey where every child discovers not only what they know, but who they are called to become.', 'Zakaria Olanrewaju Anofi'));
B.push(pageBreak());
...
rosterRow('Zakaria Olanrewaju Anofi', 'Founder & Head of Schools/Administrator', 'MSc Edinburgh Business School, Heriot-Watt · BSc Applied Accounting, Oxford Brookes · Fellow, ACCA UK · Fellow, ICAN').forEach(p => B.push(p));
...
B.push(new Paragraph({ spacing: { before: 80, after: 80 } }));
B.push(diagramRow(['Level C — Management Team (Executive Authority)\nHead of Schools/Administrator — Zakaria Olanrewaju Anofi'], GOLD, NAVY_DEEP));
...
[
  ...
  'Institutional vision presentation by Zakaria Olanrewaju Anofi',
...
B.push(quoteBox("We believe that a school's responsibility does not end at its gates. Our community is our classroom, and our obligation extends to every member of it.", 'Zakaria Olanrewaju Anofi · Founder & Head of Schools/Administrator'));
B.push(body('The Sultan Zakariya Hanafi Foundation is a non-profit, non-political organisation co-founded by Zakaria Olanrewaju Anofi and Mallam Lukman Ayinla Anofi.'));
