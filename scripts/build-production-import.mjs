...
// Order matters for readability only — the sequence repair below is
// order-independent by construction — but IBT before IDD is the order the
// numbers were issued in and the order the file should read in.
const SOURCES = ['2026-08-08-IBT-000035.sql', '2026-08-08-IDD-000042.sql'];
const OUT = `${DIR}/2026-08-08-PRODUCTION-IMPORT.sql`;
...
--
-- ${rows.length} certificates, already issued, already printed, already handed to
...
--    issues is 0000${maxSeq + 1} — never 000042 again, which is engraved on a
